...
log_dir="/media/nvme/palma/icl_bimanual/paper_videos/bicicle"
...
task_init_rotation["bimanual_take_item_out_of_box"]=280
task_init_rotation["bimanual_close_jar"]=280
