...
class PingPongBestOfN(Agent):
    """Hybrid agent: N parallel PingPong (4-call iterative refinement) candidates
    scored by an LLM-as-judge validator.  Combines the diversity of BestOfN with
    the coordination quality of PingPong's iterative leader-follower debate."""
    ...
    def __init__(self, task_name, model_config):
        ...
        # Use the same proven system prompts as the original PingPong agent
    ...
    def _build_shuffled_prompts(self, parsed_leader_examples, leader_obs_suffix,
        ...
        """Build shuffled prompts for all 4 PingPong calls of one candidate."""
    ...
    # ── Candidate generation (4-call PingPong pipeline) ──────────────────────
    ...
    def act(self, step: int, observation: dict,
        ...
        if len(self.actions) == 0:
            ...
            print(f"PingPongBestOfN scores: {scores}, selected candidate {best_idx} "
