...
def restore_params(
    ...
    *,
    ...
    with ocp.PyTreeCheckpointer() as ckptr:
        ...
        # orbax >= 0.11.33: metadata() returns StepMetadata; unwrap to pytree metadata
        pytree_meta = metadata.item_metadata if hasattr(metadata, "item_metadata") else metadata
        item = {"params": pytree_meta["params"]}
